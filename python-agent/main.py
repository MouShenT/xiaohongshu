...
from api.routers import health, xhs_api, agent_chat, agent_pipeline, rag, data_clean, analysis, content_writer
...
app.include_router(content_writer.router, prefix="/api/v1/writer", tags=["AI 创作"])
